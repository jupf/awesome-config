...
local function worker(args)
    ...
    net_icon:set_image(ICON_DIR.."wifi_na.png")
    ...
    local function net_update()
        ...
        if signal_level == nil then
            ...
            if signal_level < 25 then
                net_icon:set_image(ICON_DIR.."wifi_0.png")
            elseif signal_level < 50 then
                net_icon:set_image(ICON_DIR.."wifi_1.png")
            elseif signal_level < 75 then
                net_icon:set_image(ICON_DIR.."wifi_2.png")
            else
                net_icon:set_image(ICON_DIR.."wifi_3.png")
            end
        end
    end
    ...
    local function text_grabber()
        ...
        if connected then
            ...
            -- Use iw/ip
            local f = io.popen("/sbin/iw dev "..interface.." link")
