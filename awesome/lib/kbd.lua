...
kbdwidget.bg_image = wibox.widget.imagebox()
kbdwidget.bg_image:set_image(kbd_img_path .. "us.png")
...
kbdwigetwmargin = wibox.layout.margin()
kbdwigetwmargin:set_widget(kbdwiget)
kbdwigetwmargin:set_left(0)
kbdwigetwmargin:set_right(10)
-- }}}
